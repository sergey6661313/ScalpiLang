...
Разница по отношениею к языку Си:
  + нет путаници с указателями и знаком умножения.
    Все переменные ВСЕГДА рассматриваются как обозначение смещения (относительно начала фаила, стека, адресса и др.) в памяти. 
  ...
  + однозначность действия скобочек - изменеие приоритета.
    ...
    Указание типа не вкоем случае не обозначает конвертирование числа.
